        ...
        <div className={'w-full h-screen flex-col justify-around overflow-clip'}>
            ...
            <header className={"h-44 flex items-center justify-around z-10 relative top-0 left-0"}>
                <div className={'flex items-center justify-center w-60 font-black z-10 text-2xl hover:text-3xl hover:cursor-pointer'}>
                    ...
                    <h1 className={' text-white drop-shadow-md text-lg'}>SHADOW AUTOMOBILE</h1>
                </div>
                <div className='flex'>
            ...
            <div className={'absolute bottom-20 left-24 flex z-20 justify-around items-center'}>
                <div className={'z-20  w-1/2'}>
                    <h1 className={'text-white text-7xl font-black z-20 tracking-wide drop-shadow-2xl'}>LET'S GET YOU <span className={'text-red-700'}>ON THE ROAD</span></h1>
                </div>
                <Button variant="contained" color='primary' className='h-16 w-1/4 rounded-3xl bg-red-600 text-md font-bold hover:bg-red-500' endIcon={<ArrowForwardIcon />}>Request a quote</Button>
            </div>
        </div>

    ...
    return (
        ...
        <div className='h-screen w-full bg-white z-30'>
            ...
            <div className='h-1/2 w-full bg-white flex z-30 justify-around items-center'>
                <Image className='h-4/5 w-auto rounded-md' src={Engine} alt="Motor" />
                <div className='flex flex-wrap  w-2/6'><p className='text-2xl text-black'>Shadow Automobile is a leading brand in car design, manufacturing, and maintenance. With our cutting-edge technology, we give you tomorrow's vehicles, today!</p></div>
            </div>
        </div>
